...
def detect_for_debug():
    ...
    EMAIL3 = 'hello@gmail.com'

    leak_detector = LeakDetector(
            [PWD, PWD2, EMAIL, EMAIL2, EMAIL3], encoding_set=ENCODINGS_NO_ROT,
    ...
    #URL = "https://output.jsbin.com/levuwoc?ZW1haWwlM0RoZWxsbyU0MGdtYWlsLmNvbQ==&cGFzc3dvcmQlM0R3b3JsZA=="
    URL = "https://output.jsbin.com/levuwoc/34?ZW1haWwlM0RoZWxsbyU0MGdtYWlsLmNvbQ==&cGFzc3dvcmQlM0R3b3JsZA=="
    #First base64, then url encode --> breaks on the last %3D
    #URL = "https://output.jsbin.com/levuwoc?ZW1haWw9aGVsbG9AZ21haWwuY29t&cGFzc3dvcmQ9d29ybGQ%3D"
    #With 'id = for email and password and only base64'
    #URL = "https://output.jsbin.com/levuwoc?ZW1haWw9aGVsbG9AZ21haWwuY29t&cGFzc3dvcmQ9d29ybGQ="
